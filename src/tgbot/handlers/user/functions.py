...
async def show_version(m: Message):
    await m.answer("""моя версия: 2.4.8 (3 обновление)
список изменений:
...
А ещё, как все разработчики любят писать, улучшена стабильность работы (ну кстати бот действительно должен работать стабильней, всё-таки команда тестировщиков появилась)
""")
